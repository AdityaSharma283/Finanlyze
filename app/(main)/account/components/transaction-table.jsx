...
const handlePageChange = (newPage) => {
  ...
  return <div className="space-y-4">
    {deleteLoading && (
<BarLoader className="mt-4" width={"100%"} color="#33eaaa" />
    )}
{/* Filters */}
            ...
            <TableCell>
                {transaction.isRecurring?(
                    ...
                    <Tooltip>
                      ...
                      <Badge
                        variant="outline"
                        className="gap-1 px-3 py-1 rounded-lg bg-green-200 text-green-700 hover:bg-green-300 flex items-center justify-center"
                        >
